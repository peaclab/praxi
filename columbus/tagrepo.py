...
class Tagrepo():
	def __init__(self):
		...
		'copyright','auto', 'test', 'man1', 'man8', 'systemd','LC_M','right' ]
		self.filterPrefixTags = ['lib', 'local', 'dist','x86_64', 'CP', 'ISO', 'IBM', 'encod', 'cert', 'ca-', 'changelog', 'LC_M', 'America', 'Asia', 'system', 'man', 'Europe', 'Africa', 'apt', 'dpkg']
