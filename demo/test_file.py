...
subprocess.call(["./demo_main.py", "-t", "demo_tagsets/iter_init", "-s", "demo_tagsets/sl_test_tag", "-o", "results", "-i", "-l"]) # Run command
subprocess.call(["./demo_main.py", "-t", "demo_tagsets/iter_add", "-s", "demo_tagsets/sl_test_tag", "-o", "results", "-i", "-p", "it_model.p"]) # Run command
print("Done!")
